...
const deninirCompra = (numberMoney) => {
    ...
    if (din >= 0.6 && din < 1) return (`${numberMoney} compra helado de agua y te sobran ${numberMoney - 0.6}`);
    if (din >= 1 && din < 1.6) return (`${numberMoney} compra helado de crema y te sobran ${numberMoney - 1}`);
    if (din >= 1.6 && din < 1.7) return (`${numberMoney} compra helado de heladix y te sobran ${numberMoney - 1.6}`);
    if (din >= 1.7 && din < 1.8) return (`${numberMoney} compra helado de heladovich y te sobran ${numberMoney - 1.7}`);
    if (din >= 1.8 && din < 2.9) return (`${numberMoney} compra helado de helardo y te sobran ${numberMoney - 1.8}`);
    if (din >= 2.9) return (`${numberMoney} compra el pote de 1/4KG o el potecito de helado con confites y te sobran ${numberMoney - 2.9}`);
